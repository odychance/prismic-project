 ...
 */
export interface FeaturesSliceDefaultPrimaryItemItem {
  /**
   * Icon field in *Features → Default → Primary → Items*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.item[].icon
   ...
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.item[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.item[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface FeaturesSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: features.default.primary.item[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  item: prismic.GroupField<Simplify<FeaturesSliceDefaultPrimaryItemItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      FeaturesSlice,
      FeaturesSliceDefaultPrimaryItemItem,
